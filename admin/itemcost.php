<?php
 session_start();
  ...
  $photo = "select * from photography";
  $getphoto = $crud->getData($photo);

  $chine = "select * from cinematography";
  $getchine = $crud->getData($chine);

  $drone = "select * from drone";
  $getdrone = $crud->getData($drone);

  $stage = "select * from stage";
  $getstage = $crud->getData($stage);
	...
	<div class="sidebar">
		...
		<div class="sidebar-menu">
			<ul>
				...
				<li>
					<a href="itemcost.php" class="active"><span class="las la-shopping-bag"></span><span>Item Cost</span></a>
				</li>
					...
					<div class="projects">
						<div class="card">
							<div class="card-header">
								...
								<button><a href="adddrone.php"><  ADD  ></a></button>
							</div>
							...
							<div class="card-body">
								<div class="table-responsive">
									<table width="100%">
										...
										<tbody>
											<?php foreach($getdrone as $key=>$package) {?>

											<tr>
												<td><?php echo $package['catagory'];?></td>
												<td><?php $cus_price = $package['price']; echo $cus_price; ?></td>								
											</tr>
											<?php }?>
										</tbody>
									</table>
								...
								<div class="table-responsive">
									<table width="100%">
										...
										<tbody>
											...
											<tr>
												<td><?php echo $package['catagory'];?></td>
												<td><?php $cus_price = $package['price']; echo $cus_price + 10000; ?></td>								
											</tr>
											<?php }?>
										</tbody>
									</table>
