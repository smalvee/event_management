<?php
 session_start();
  ...
  $query2 = "select * from stage order by id desc";
...
if(isset($_POST['submit'])){
    ...
    $result = $crud->execute("INSERT into stage (catagory, price) VALUES('$catagory', '$price')");
...
<body>
	...
	<div class="main-content">
		...
		<main>
			<form action="addstage.php" method="post">
				<div><h3 style="text-align: center; margin-bottom: 20px;">Add Stage Catagory</h3></div>
