<?php
 session_start();
  ...
  $query2 = "select * from cinepackage";
...
if(isset($_POST['submit'])){
    ...
    $result = $crud->execute("INSERT into cinepackage (package_name, price, details) VALUES('$package_name', '$price', '$details')");

    if($result)
				{
					echo "<h3><script>alert('Done');</script></h3>";
					header("location:addcinepackage.php");
				}
				else
				{
...
<body>
	...
	<div class="sidebar">
		...
		<div class="sidebar-menu">
			<ul>
				...
				<li>
					<a href="addcinepackage.php" class="active"><span class="las la-shopping-bag"></span><span>Cinematography Package</span></a>
				</li>
				<li>
	...
	<div class="main-content">
		...
		<main>
			<div><h3 style="text-align: center; margin-bottom: 20px;">Add Cinematography Package</h3></div>
