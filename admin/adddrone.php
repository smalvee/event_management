...
if(isset($_POST['submit'])){
    ...
    $result = $crud->execute("INSERT into drone (catagory, price) VALUES('$catagory', '$price')");

    if($result)
				{
					echo "<h3><script>alert('Done');</script></h3>";
					header("location:adddrone.php");
				}
				else
				{
...
<body>
	...
	<div class="main-content">
		...
		<main>
			<form action="adddrone.php" method="post">
				<div><h3 style="text-align: center; margin-bottom: 20px;">Add Drone Catagory</h3></div>
