<?php
 session_start();
  ...
  $query2 = "select * from cinematography";
...
if(isset($_POST['submit'])){
    ...
    $result = $crud->execute("INSERT into cinematography (catagory, price) VALUES('$catagory', '$price')");

    if($result)
				{
					echo "<h3><script>alert('Done');</script></h3>";
					header("location:addcine.php");
				}
				else
				{
...
<body>
	...
	<div class="main-content">
		...
		<main>
			<form action="addcine.php" method="post">
				<div><h3 style="text-align: center; margin-bottom: 20px;">Add Cinematographer Catagory</h3></div>
			<table width="100%" style="background: #fff;">
				...
				<tbody>
					<tr>
						<td><input style="width: 100%; height: 35px; border-radius: 4px;" type="text" name="package"></td>
						<td><input style="width: 100%; height: 35px; border-radius: 4px;" type="number" name="price"></td>
						<td>
							<input style=
										"color:#FFFFFF;
...
<!-- -----------------------------Cinematographer Display Section------------------------------ -->
