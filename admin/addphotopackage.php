<?php
 session_start();
  ...
  $query2 = "select * from photopackage";
...
if(isset($_POST['submit'])){
    ...
    $result = $crud->execute("INSERT into photopackage (package_name, price, details) VALUES('$package_name', '$price', '$details')");

    if($result)
				{
					echo "<h3><script>alert('Done');</script></h3>";
					header("location:addphotopackage.php");
				}
				else
				{
...
<body>
	...
	<div class="sidebar">
		...
		<div class="sidebar-menu">
			<ul>
				...
				<li>
					<a href="addphotopackage.php" class="active"><span class="las la-shopping-bag"></span><span>Photography Package</span></a>
				</li>
				<li>
	...
	<div class="main-content">
		...
		<main>
			...
			<form action="addphotopackage.php" method="post">
