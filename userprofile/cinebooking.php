<?php
 session_start();
  ...
  $cine = "Select * from cinepackage";
    
  $getcinepackage = $crud->getData($cine);
	...
	<div class="main-content">
		...
		<main>
			...
			<form action="photobooking.php" method="POST">
				...
				<div>
					<h2 style="padding-top: 2rem;">Cinematography Packages</h2>
				</div>
				...
				<div class="cards">
					...
					<?php
						foreach($getcinepackage as $key=>$pack)
							  {
					...
					<div class="card-single">
						...
						<div><button><a href="cinepreelook.php?idl=<?php echo $pack['package_name'] ?>">Book Now</a></button></div>					
					</div>
