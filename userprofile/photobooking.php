<?php
 session_start();
  ...
  $photo = "Select * from photopackage";
	...
	<div class="main-content">
		...
		<main>
			...
			<form action="photobooking.php" method="POST">
				...
				<div>
					<h2 style="padding-top: 2rem;">Photography Packages</h2>
				</div>
				...
				<div class="cards">
					...
					<div class="card-single">
						...
						<div><button><a href="photopreelook.php?idl=<?php echo $pack['package_name']?>">Book Now</a></button></div>					
					</div>
